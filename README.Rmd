...
This R Markdown document contains code to reproduce the analyses performed in our manuscript entitled **Increase of Ectodysplasin-A2-Receptor EDA2R in Aging: A Ubiquitous Hallmark and Mediator of Parainflammatory Responses** from *Barbera et al*.
